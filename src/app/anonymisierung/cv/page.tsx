...
import { anonymizationHistoryCv } from "@/data/anonymizationHistory";
import { FileText, ShieldCheck, UploadCloud, ChevronLeft } from "lucide-react";

export default function AnonymizeCvPage() {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Lebensläufe neutralisieren, bevor sie an Kunden gesendet werden.
          </p>
        </div>
              ...
              <div className="p-4">
                ...
                <div className="mb-4 rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 p-6 text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Hier wird später der Upload von PDF-Lebensläufen angebunden.
                  </p>
                  <button
                    type="button"
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    rows={12}
                    placeholder="Füge hier den Lebenslauf-Text ein..."
                  />
                </div>
              ...
              <div className="p-4">
                ...
                <div className="max-h-[600px] overflow-y-auto rounded-md border border-gray-200 bg-gray-50 p-4">
                  <pre className="whitespace-pre-wrap text-sm text-gray-800 font-sans">
                    {anonymizedText ||
                      "Noch keine Eingabe vorhanden. Füge links einen Lebenslauf ein, um die anonymisierte Vorschau zu sehen."}
                  </pre>
                </div>
              </div>
            </div>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {anonymizationHistoryCv.map((item) => (
